...
public class WeaponAim : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            weaponTransform.position = playerCurrentPosition.position + new Vector3(-0.2f, -0.5f, 0);
            weaponTransform.rotation = Quaternion.Euler(0, 0, 45f);
        }
        //move up
        ...
        {
            weaponTransform.position = playerCurrentPosition.position + new Vector3(-0.3f, -0.65f, 0);
